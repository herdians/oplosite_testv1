...
<script src="{{ asset('/bootstrap-dialog/bootstrap-dialog.min.js') }}"></script>
...
<!-- moris js -->
<script src="{{ asset('/gentelella/js/moris/raphael-min.js') }}"></script>

<!-- Parsley -->
<script src="{{ asset('/gentelella/js/parsley/parsley.min.js') }}"></script>
